    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-primary text-primary-foreground shadow-[0_8px_16px_-6px_rgba(79,70,229,0.4)] hover:shadow-[0_12px_20px_-6px_rgba(79,70,229,0.5)] hover:-translate-y-0.5": variant === "default",
