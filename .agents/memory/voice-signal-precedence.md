...
**How to apply:** Keep external outcomes scoped to the post that produced them. If a LinkedIn export does not include a feedback field, represent the result as unknown rather than assuming no feedback was reported.